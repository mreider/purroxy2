...
function SettingsSheet({ settings, onClose, onChangePath }) {
        ...
        <div className="sheet-body">
          ...
          <div className="sheet-section">
            ...
            <div className="field">
              ...
              <div className="field-hint">All your recordings live here. Each is a folder; safe to back up or sync.</div>
            </div>
            <div style={{ display: "flex", gap: 8 }}>
              <button className="btn"><Icon name="reveal" /> Reveal in Finder</button>
              <button className="btn"><Icon name="external" /> Open in Terminal</button>
            </div>
          </div>
          ...
          <div className="sheet-section">
            ...
            <div className="field">
              ...
              <input className="input input-mono" defaultValue={settings.chrome_path} />
          ...
          <div className="sheet-section">
            ...
            {advanced && (
              <div className="field">
                ...
                <input className="input input-mono" defaultValue={settings.component_path} />
          ...
          <div className="sheet-section">
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
              <button className="btn" style={{ justifyContent: "flex-start" }}><Icon name="copy" /> Copy debug info</button>
              <button className="btn" style={{ justifyContent: "flex-start" }}><Icon name="folder" /> Open log directory</button>
            </div>
            <div className="field-hint" style={{ marginTop: 12 }}>v0.4.2 · build 2026-05-04T08:14Z · WKWebView 17.4 · macOS 14.5</div>
          </div>
